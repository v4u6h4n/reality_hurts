...
prerequisite() {
    ...
    prerequisite_device() {
        ...
        # Input.
            ...
            microphone_2="desk"
            input_device_microphone_2_node_name="alsa_input.usb-POROSVOC_POROSVOC_UAC_Dongle_88156088-00.6.mono-fallback" # "alsa_input.usb-046d_Logitech_StreamCam_11536225-02.analog-stereo"
