...
class Bot(commands.Bot):
    ...
    async def event_message(self, message):
        ...
        # Check if 'emotes' tag exists in message.tags and has values
            ...
            for emote_id, positions in emotes_dict.items():
                for pos in positions:
                    ...
                    if emote_text in self.global_emotes:
                        ...
                        create_image_command = ['echo', '-e', f'\033_Ga=T,q=2,i={emote_id};d=1,{emote_image_url}\033\\']
                        ...
                        placement_command = ['echo', '-e', f'\033_Ga=p,U=1,i={emote_id},c=2,r=2\033\\']
